...
model_path = '/visuworks/Blindless_AIFFELTON/script/Pyramid/model_parameters/sliced_30epochs_g_clahe.h5'
history_path = '/visuworks/Blindless_AIFFELTON/script/Pyramid/history/sliced_30epochs_g_clahe_history.json'
