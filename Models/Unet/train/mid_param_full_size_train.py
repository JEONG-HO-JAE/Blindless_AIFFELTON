...
sys.path.append("/visuworks/Blindless_AIFFELTON/Models/Unet")
import model_mid_param

input_shape = (256, 256, 1) # Adjust based on your input data
model = model_mid_param.Unet_mid_para(input_shape, 1)
model.summary()
...
model_path = '/visuworks/Blindless_AIFFELTON/script/Unet/model_parameters/big_param_30epochs_g_clahe.h5'
history_path = '/visuworks/Blindless_AIFFELTON/script/Unet/history/big_param_30epochs_g_clahe_history.json'
