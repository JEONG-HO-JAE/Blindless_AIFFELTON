...
model_path = '/visuworks/Blindless_AIFFELTON/Models/Dense_Unet/model_parameters/30epochs_g_clahe.h5'
history_path = '/visuworks/Blindless_AIFFELTON/Models/Dense_Unet/history/30epochs_g_clahe_history.json'
